...
public class StrategyController {
    ...
    public String addingStrategy(@Valid @ModelAttribute Strategy strategy,
        ...
        if (result.hasErrors()) {
            ...
            try {
                ...
                String message = messageSource.getMessage("ctrl.message.success.add", new Object[] {businessObject, strategy.getName()}, Locale.US);
    ...
    public String editingStrategy(@Valid @ModelAttribute Strategy strategy,
        ...
        if (action.equals(messageSource.getMessage("button.action.cancel", null, Locale.US))) {
            String message = messageSource.getMessage("ctrl.message.success.cancel", new Object[] {"Edit", businessObject, strategy.getName()}, Locale.US);
            redirectAttrs.addFlashAttribute("message", message);
            ...
            try {
                ...
                String message = messageSource.getMessage("ctrl.message.success.update", new Object[] {businessObject, strategy.getName()}, Locale.US);
                redirectAttrs.addFlashAttribute("message", message);
            } catch (StrategyNotFoundException snf) {
                String message = messageSource.getMessage("ctrl.message.error.notfound", new Object[] {businessObject, strategy.getName()}, Locale.US);
                redirectAttrs.addFlashAttribute("error", message);
                return "redirect:/strategy/list";
            } catch (DuplicateStrategyException dse) {
                String message = messageSource.getMessage("ctrl.message.error.duplicate", new Object[] {businessObject, strategy.getName()}, Locale.US);
                redirectAttrs.addFlashAttribute("error", message);
                return "redirect:/strategy/list";
            }
        }
    ...
    public String deleteStrategyPage(
        ...
        try {
            ...
            message = messageSource.getMessage("ctrl.message.error.notfound", new Object[] {"Strategy number", id}, Locale.US);
            redirectAttrs.addFlashAttribute("error", message);
            return "redirect:/strategy/list";
        }
        ...
        if (phase.equals(messageSource.getMessage("button.action.cancel", null, Locale.US))) {
            message = messageSource.getMessage("ctrl.message.success.cancel", new Object[] {"Delete", businessObject, strategy.getName()}, Locale.US);
            redirectAttrs.addFlashAttribute("message", message);
            return "redirect:/strategy/list";
            ...
            try {
                ...
                message = messageSource.getMessage("ctrl.message.success.delete", new Object[] {businessObject, strategy.getName()}, Locale.US);
                redirectAttrs.addFlashAttribute("message", message);
                return "redirect:/strategy/list";
            } catch (StrategyNotFoundException e) {
                message = messageSource.getMessage("ctrl.message.error.notfound", new Object[] {businessObject, strategy.getName()}, Locale.US);
                redirectAttrs.addFlashAttribute("error", message);
                return "redirect:/strategy/list";
            }
        }
